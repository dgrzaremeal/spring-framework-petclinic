...
class PetControllerTests {
    ...
    @Test
    void testInitCreationForm_shouldHaveGendersModelAttribute() throws Exception {
        mockMvc.perform(get("/owners/{ownerId}/pets/new", TEST_OWNER_ID))
            .andExpect(status().isOk())
    ...
    @Test
    void testProcessCreationFormWithGenderMale() throws Exception {
        mockMvc.perform(post("/owners/{ownerId}/pets/new", TEST_OWNER_ID)
            .param("name", "Buddy")
            .param("type", "hamster")
            .param("birthDate", "2015/02/12")
    ...
    @Test
    void testProcessCreationFormWithGenderFemale() throws Exception {
        mockMvc.perform(post("/owners/{ownerId}/pets/new", TEST_OWNER_ID)
            .param("name", "Bella")
            .param("type", "hamster")
            .param("birthDate", "2015/02/12")
    ...
    @Test
    void testProcessCreationFormWithGenderUnknown() throws Exception {
        mockMvc.perform(post("/owners/{ownerId}/pets/new", TEST_OWNER_ID)
            .param("name", "Mystery")
            .param("type", "hamster")
            .param("birthDate", "2015/02/12")
    ...
    @Test
    void testProcessCreationFormWithoutGenderDefaultsToUnknown() throws Exception {
        // No gender param — field initializer defaults to UNKNOWN, should succeed
        mockMvc.perform(post("/owners/{ownerId}/pets/new", TEST_OWNER_ID)
            .param("name", "NoGender")
            .param("type", "hamster")
            .param("birthDate", "2015/02/12")
