...
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (1, 'Leo', '2000-09-07', 1, 1, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (2, 'Basil', '2002-08-06', 6, 2, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (3, 'Rosy', '2001-04-17', 2, 3, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (4, 'Jewel', '2000-03-07', 2, 3, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (5, 'Iggy', '2000-11-30', 3, 4, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (6, 'George', '2000-01-20', 4, 5, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (7, 'Samantha', '1995-09-04', 1, 6, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (8, 'Max', '1995-09-04', 1, 6, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (9, 'Lucky', '1999-08-06', 5, 7, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (10, 'Mulligan', '1997-02-24', 2, 8, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (11, 'Freddy', '2000-03-09', 5, 9, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (12, 'Lucky', '2000-06-24', 2, 10, 'UNKNOWN') ON CONFLICT DO NOTHING;
INSERT INTO pets (id, name, birth_date, type_id, owner_id, gender) VALUES (13, 'Sly', '2002-06-08', 1, 10, 'UNKNOWN') ON CONFLICT DO NOTHING;
