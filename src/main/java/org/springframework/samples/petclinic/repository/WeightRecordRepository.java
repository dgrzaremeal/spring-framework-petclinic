...
/**
 * Repository interface for {@link WeightRecord} domain objects.
...
public interface WeightRecordRepository {
     ...
     * @return list of weight records in chronological order
     */
     ...
     *
     * @param weightRecord the weight record to save
     */
